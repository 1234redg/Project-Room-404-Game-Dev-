...
public class KeyHandler implements KeyListener {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (gp.gameState == gp.playState) {
            ...
            // Clue Tracker confirm and retry (K key)
            if (code == KeyEvent.VK_K) {
                if (gp.clueTrackerUI != null && gp.clueTrackerUI.isVisible()) {
                    if (gp.clueTrackerUI.isFeedbackShowing()) {
                        gp.clueTrackerUI.resetGuesses();
                    } else {
                        gp.clueTrackerUI.confirmGuesses();
                    }
                }
            }
