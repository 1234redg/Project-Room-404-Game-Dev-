...
public class GameUI {
    ...
    public void drawDialogueScreen() {
        ...
        // 1-inch right margin
        int rightMargin = 96; // pixels
        int maxWidth = width - gp.tileSize * 2 - rightMargin;

        // Split currentDialogue into wrapped lines
        List<String> lines = wrapText(currentDialogue, maxWidth);
