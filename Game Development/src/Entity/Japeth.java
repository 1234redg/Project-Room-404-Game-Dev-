...
public class Japeth extends  Entity {


    public Japeth(GamePanel gp) {
        super(gp);
    ...
    public void getImage() {
        try {
            ...
            down1 = ImageIO.read(getClass().getResourceAsStream("/NPC/NPC5_Idle1.png"));
            down2 = ImageIO.read(getClass().getResourceAsStream("/NPC/NPC5_Idle2_Stretched.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
